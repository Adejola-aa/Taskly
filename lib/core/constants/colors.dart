...
class AppColors {
  ...
  static const Color primaryDark = Color(0xFF5B52F5);
  ...
  static const Color inputBackground = Color(0xFFFAFAFC);
  static const Color softSurface = Color(0xFFF1F2F8);
  ...
  static const Color highPriority = Color(0xFFFF5A5F);
  static const Color mediumPriority = Color(0xFFFFB547);
  static const Color lowPriority = Color(0xFF57C084);

  static const Color success = Color(0xFF57C084);
  ...
  static const Color categoryPurple = Color(0xFF8B7CFF);
  static const Color categoryGreen = Color(0xFF4FD1A5);
  static const Color categoryOrange = Color(0xFFFFA94D);
